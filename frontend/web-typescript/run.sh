...
check_env INFLUSS_SERVER_EXTERNAL_API_HOST $INFLUSS_SERVER_EXTERNAL_API_HOST
check_env INFLUSS_SERVER_EXTERNAL_API_PORT $INFLUSS_SERVER_EXTERNAL_API_PORT
check_env INFLUSS_FRONTEND_1_PORT $INFLUSS_FRONTEND_1_PORT

docker run -i -t \
    --name $CONTAINER_NAME \
    --env "INFLUSS_SERVER_EXTERNAL_API_HOST=${INFLUSS_SERVER_EXTERNAL_API_HOST}" \
    --env "INFLUSS_SERVER_EXTERNAL_API_PORT=${INFLUSS_SERVER_EXTERNAL_API_PORT}" \
