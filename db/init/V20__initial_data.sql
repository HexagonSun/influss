INSERT INTO MESSAGE (TEXT, VALID_FROM, INVALID_FROM, AUTHOR, CREATED_AT, MODIFIED_AT, DELETED) VALUES (
...
INSERT INTO MESSAGE (TEXT, VALID_FROM, INVALID_FROM, AUTHOR, CREATED_AT, MODIFIED_AT, DELETED) 
	SELECT
		msg,
